												...
												<div class="kt-timeline-v2__items  kt-padding-top-25 kt-padding-bottom-30">
													...
													<div class="kt-timeline-v2__item">
														...
														<div class="kt-list-pics kt-list-pics--sm kt-padding-l-20">
															<a href="#"><img src="{{ asset("/media/users/100_4.jpg")}}" title=""></a>
															<a href="#"><img src="{{ asset("/media/users/100_13.jpg")}}" title=""></a>
															<a href="#"><img src="{{ asset("/media/users/100_11.jpg")}}" title=""></a>
															<a href="#"><img src="{{ asset("/media/users/100_14.jpg")}}" title=""></a>
														</div>
													</div>
													<div class="kt-timeline-v2__item">
											...
											<div class="kt-widget19__wrapper">
												<div class="kt-widget19__content">
													<div class="kt-widget19__userpic">
														<img src="{{ asset("/media//users/user1.jpg")}}" alt="">
													</div>
