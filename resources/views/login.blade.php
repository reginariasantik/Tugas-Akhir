		...
		<div class="kt-grid kt-grid--ver kt-grid--root">
			<div class="kt-grid kt-grid--hor kt-grid--root  kt-login kt-login--v6 kt-login--signin" id="kt_login">
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--desktop kt-grid--ver-desktop kt-grid--hor-tablet-and-mobile">
					<div class="kt-grid__item  kt-grid__item--order-tablet-and-mobile-1  kt-grid kt-grid--hor kt-login__aside">
								...
								<div class="kt-login__body">
									...
									<div class="kt-login__signin">
										<div class="kt-login__head">
											<h3 class="kt-login__title">Helpdesk Ticketing System</h3>
										</div>
										<div class="kt-login__form">
											<form class="kt-form" action="/signin">
												<div class="form-group">
													...
													<button id="kt_login_signin_submit" class="btn btn-brand btn-pill btn-elevate" button type="submit">Sign In</button>
												</div>
											</form>
										</div>
                                    </div>
                        ...
                        <div class="kt-grid__item kt-grid__item--fluid kt-grid__item--center kt-grid kt-grid--ver kt-login__content" style="background-image: url('{{asset("assets/media/bg/tes.jpg")}}')" >
